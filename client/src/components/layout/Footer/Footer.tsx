        ...
        <div className="grid lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="flex space-x-4">
              <button
                type="button"
                className="text-gray-400 hover:text-black cursor-pointer transition-all duration-300 ease-in-out hover:bg-pink hover:text-black cursor-pointer[#e189fa] p-2 border border-pink rounded-full"
              >
                <IconBrandX className="h-5 w-5" size={20} />
              </button>
              <button
                type="button"
                className="text-gray-400 transition-all duration-300 ease-in-out hover:bg-pink hover:text-black cursor-pointer p-2 border border-pink rounded-full"
              >
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <form className="flex space-x-3">
              ...
              />
              <button
                className="bg-[#e189fa] hover:bg-[#d175f0] text-black px-6"
                type="submit"
              >
                Subscribe
              </button>
