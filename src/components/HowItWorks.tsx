import { Search, Calendar, CheckCircle, Bell, Users, BarChart3 } from "lucide-react";
  ...
  const clientSteps = [
    {
      ...
      description: "Search for service providers by category, location, and ratings. View profiles, reviews, and availability."
    },
    {
      step: "2", 
      icon: <Calendar className="h-6 w-6" />,
      title: "Book Appointment",
      description: "Fill out a simple booking form with your details and preferred time. Submit your appointment request."
    },
    {
      step: "3",
      icon: <CheckCircle className="h-6 w-6" />,
      title: "Get Confirmed",
      description: "Receive confirmation when your appointment is accepted, or alternative suggestions if declined."
    },
    {
      step: "4",
      icon: <Bell className="h-6 w-6" />,
      title: "Attend & Complete",
      description: "Get reminders before your appointment. Attendance is automatically tracked and marked as complete."
    }
  ];
  ...
  const providerSteps = [
    {
      ...
      description: "New appointment requests appear instantly on your dashboard with all client details and preferences."
    },
    {
      step: "2",
      icon: <CheckCircle className="h-6 w-6" />,
      title: "Accept or Decline",
      description: "Review requests and make decisions. Clients are automatically notified via email of your response."
    },
    {
      step: "3",
      icon: <Calendar className="h-6 w-6" />,
      title: "Auto-Schedule",
      description: "Accepted appointments are automatically added to your calendar with all necessary details."
    },
    {
      step: "4",
      icon: <BarChart3 className="h-6 w-6" />,
      title: "Track & Manage",
      description: "Monitor appointment status, track completions, and analyze your business performance."
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center space-y-4 mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            A streamlined process designed for both clients and service providers 
            to make appointment management effortless.
          </p>
        </div>
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            ...
            <h3 className="text-2xl font-bold text-black">Book Your Perfect Appointment</h3>
          </div>
        ...
        <div>
          <div className="text-center mb-12">
            ...
            <h3 className="text-2xl font-bold text-black">Manage Your Business Efficiently</h3>
          </div>
